...
const updateUserInfo = async (req, res) => {
  try {
    ...
    application.workAuthorization =
      body.workAuthorization || application.workAuthorization;
    ...
    application.licenseExpirationDate =
      body.licenseExpirationDate || application.licenseExpirationDate;
              ...
              s3.upload(params, async (err, data) => {
                if (err) {
                  ...
                  if (fileName === "licenseCopyUrl") {
                    ...
                    application[`${fileName}Preview`] = previewUrl;
                  }
                  resolve();
                  //   console.log(applicationDetails);
                }
...
module.exports = { getUserInfo, updateUserInfo, updateFiles };
